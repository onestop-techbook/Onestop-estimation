...
とはいえ元々のブログよりも不便になったり、これまで使っていた機能が使えなくなってしまうことは避けなくてはいけません。

　ブログデザインも必要です。WordPressであれば無料テーマから好きなものを選んでもらうことでとりあえずの体裁は整えることもできますが、独自のブログシステムを作るとなると自前で用意しなければいけません。
さらに管理画面の設計も必要です。
...
　見積もりが完了し了承を得ることができたため実際に開発を始めます。Iはシステムの開発に専念し、その間私とSさんでページデザインを考案します。
...
もちろんIが作る予定だった機能やセキュリティはありませんが当初のSさんの要望であった独自ドメインブログへの移行だけであればすぐにでも完了できます。
...
　見積もりといえば費用や工数を思い浮かべる方が多いでしょうが、チームで案件にあたる場合それ以前に他人の能力を見積もらなければいけません。
フリーランスとしてひとりでする仕事ならともかく、多くの人は会社組織に属しチームで仕事をしているはずです。
今回のケースでは私はフリーランスチームリーダーという立場で人事権も意志決定権も握っていたためなおさらですし、逆に言えばすべての責任を負うことになります。
...
私は画一的な答えを持ちませんし、新規開発ともなれば正確な工数をも積もるのは困難ですが、失敗する可能性が限りなく低い例をひとつご紹介します。
