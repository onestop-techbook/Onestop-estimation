...
など、こういった未知（はじめて）の事象に対しては十分な余裕を持ち取り組む必要があります。
...
顧客によっては、言語や文化の違い、業務の多忙などから、日常的なコミュニケーションが困難になる場合があります。
この場合には、相当のコミュニケーションコストが想定されます。
たとえば、オフショア開発チームと日本語でのコミュニケーションが困難な場合に何回も手戻りが発生し、工数が膨れ上がるといった可能性を考慮するべきです。
...
とくに前段までに説明した通り、@<b>{他者によって影響される部分}には必ず安全マージンを想定するでしょう。
...
ここまで述べた通り、安全マージンは心理的安全性を担保するために設定されていますので、作業を後伸ばしする理由にしてはなりません。
