...
1点見積もりの場合、実績と見積もりを比較した時は次のどちらかが多くなります。
...
ここで重要なのは@<b>{ふりかえりによる改善の対象となりやすい}ということです。1点見積もりで見積もりより実績が少なくなった場合は、誰かが「見積もりより小さいことは問題だ」といわなければ改善の対象になりにくいでしょう。ですが、2点見積もりでは最小と最大のふたつの定義があることによって、実績が最小と最大のあいだのどの位置にあたるのかを考えやすくなります。そのため、強く意識しなくてもふりかえりがしやすくなります。

 * 見積もり精度を上げやすい

前述のふりかえりの話にも関連していますが、ふりかえり結果から見積もり精度を上げやすいのも特徴です。1点見積もりでは、実績が見積もりを上回ったか、下回ったかのどちらかしかありません。2点見積もりでは最小以下、最小と最大の間、最大以上の大きく三つに分かれます。また最小と最大の間でも、最小寄りなのか最大寄りなのかによって次の行動を変えられます。これだけ評価軸を増やせるのは、2点見積もりを用いる利点となっています。
...
しかし、2点見積もりでは見積もりの定義が明確です。最大見積もりの定義は「そのタスクが確実に完了できる工数」なので、確実に完了できる工数を超過していることになります。そのため、事前に検討できていない項目があったのではないか、見積もり内容に問題があったのではないか、タスク消化中に非常に大きな問題が発生したのではないか、など単に不確実な1点見積もりを超過した場合に比べて考えやすくなります。
...
その点、2点見積もりなら最初から定義が決まっているので、過去のことを思い出す必要はありません。決められた定義のまま扱えば大丈夫です。チーム内や組織内でコミュニケーションを取るときにも、認識の違いが起こることはありません。勘違いや前提の違いで手戻りが発生しにくいのはよいポイントです。見積もり自体が不確実なものなのに、それを運用する中に不確実性があると非常に大変です。少しでも不確実性が減らせると、よりよい見積もりができます。
...
2点見積もりは、最初からブレることを前提にしています。つまり最小見積もりと最大見積もりという2点を取るため、その間に入れば「まずは想定通り」となります。つまり見積もりとしては、高い確率で自分の想定通りとなる仕組みです。そういう意味で、大幅に外れることが少ないので、見積もりに対して高いモチベーションを保つことができます。また、最小見積もりをストレッチ目標として意識することで、より正確な最小見積もりを出すモチベーションにもなります。すぐ到達できる目標よりも、できそうでできないレベルの方がモチベーションは維持しやすくなります。
...
見積もりをしていて、こんなことをいわれたことはないでしょうか。そんな質問に対して、これまでは明確な根拠もなく、今までの経験で乗り切ってきたことでしょう。ですが、2点見積もりとふりかえりを続けることで、こんな質問にもこう答えられるようになります。
...
=== 筆者の事例
 ...
 : 調査タスクも見積もりしよう
    　調査は結果が出るか出ないわからないので見積もりしないケースがありますが、筆者は見積もりをしたほうがよいと考えます。
