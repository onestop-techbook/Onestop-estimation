...
== 2点見積もりとは?
みなさんが見積もりをするとき、多くの方が次のように考えるのではないでしょうか?

 * だいたい2日あればできるな、マージンいれて3日にしとこう。
 * うーん、1時間でできそうだけど、サボりたいから6時間と言っておこう。

つまり見積もった数字を「1点」で表現します。2点見積では次のように考えます。
...
まず多くの方が使われているだろう1点見積もりのデメリットを説明していきます。1点見積もりには次のデメリットがあります。
...
1点見積もりではその見積もり結果の定義が曖昧であるため、
同じ3日でも人によって解釈が異なってしまいます。

 * ある人は、最速でやって3日と考えるでしょう。
 * 別の人は、余裕をみて3日と考えるかもしれません。
 * あるいは、よくわからないから適当に3日と考えるかもしれません。
...
たとえば5日かかる仕事が3日で終わった場合、残り2日をその仕事の完成度を高める時間に使ってしまう、あるいは早く終わったので報告せずにサボってしまう可能性が出てきます。
...
皆さんは夏休みの宿題を期日までに終わらせていましたか?余裕があるとギリギリまで着手しない方も多いのではないでしょうか?そして、新学期が始まっても日記を書いていたりとか…。
同じことが仕事の見積もりでも起こります。

たとえばある人が出した見積もりが5日だとします。このうち2日はマージンだとすると、人によっては最初の2日間に作業しない可能性があります。そして残り3日でやり始めますが、だいたい見積もりは外れることが多いので当初の見積もりを超過してしまいます。

このように次のような問題が起こる可能性があります。
...
もし、見積もりした日数を超過するとわかった場合、次のようにモチベーションが下がってしまうことがあります。

「どうせ遅れるんだし2日も3日も変わらないから、3日遅れるって言っとこうっと」

このように最低限の遅れで済んだはずが、間に合わせようという意識がなくなることで傷口が広がってしまうことがあります。また間に合わなかったという意識から本人のモチベーションがダウンする場合があります。

 * 見積もり超過の判明によりモチベーションがダウンし作業効率がさらに下がる場合がある

というわけで1点見積もりには次のような問題がありました。
...
2点見積もりでは次の定義で見積もりをします。そしてこれらの定義により1点見積もりの問題を解決します。
...
見積もりをしていて、こんなことをいわれたことないでしょうか?そんなときこれまでは明確な根拠もない今までの経験で乗り切ってきたと思います。ですが、2点見積もりと振り返りを続けることで、こんな質問にもこう答えられるようになります。
...
このように振り返りによって、見積もり精度を向上させるためにPDCAを回すことができます。1点見積もりでも可能ですが、前述した補正のしやすさを考えるとCとAがやりやすい2点見積もりのほうが向いているといえるでしょう。
...
これまでのメリットにより見積もりに自信が出てきます。つまり迷うこと、悩むことが少なくなります。人間は決めることに多量の労力を使う生き物だといわれています。見積もりは判断と決断の連続なので、これを自信を持って（迷わず悩まず）行うことができれば、本来労力をかけるべきタスクの実行に集中することができます。また、見積もりの正しさはあなたの信頼貯金として蓄積されていきます。
 ...
 繰り返しますが常に100%正しい見積もりなんてあり得ません。2点見積もりでも実績とズレることは当然あります。ですが、2点見積もりとその実績、そして振り返りの結果は、それでもあなたが信頼してもらえる材料となることでしょう。
...
==== タスク種別
  ...
  タスク種別はそのタスクの発生種別になります。もともと計画されていたものなのか?計画後に新たに追加された物なのか?割り込みなのか?そういったことを記録しておくことで振り返り時に、見積もりと実績の乖離を分析する一助とします。
...
* 最小見積もり=実績であれば0%（バッファ消費なし）
* 最大見積もり=実績であれば100%（すべてのバッファを消費した）
* バッファ/2=実績であれば50%（バッファの半分を消費した）
...
==== 最小見積もり次の実績
    ...
    早く終わったからOKとなりがちですが、問題があります。思い出してください、最小見積もりの定義は、達成可能か不可能かギリギリの挑戦的な日数」です。ギリギリなのに早まるということは無意識にマージンを取ってしまっていることになります。マージンはバッファとして詰むので最小はあくまでギリギリを攻めましょう。
...
==== 最大見積もりを超過した
    ...
    これらはすべて見積もりに不確定要素を含んでしまったがために起こりま不確定な部分は調査タスクとして別タスクに切り出しましょう。そうすることで、問題を分割し個々の見積もり精度を上げることができます。また不確定な部分は得意な人に切り出すことができます。見積もりが上手くいかない部分は得意な人にまかせてしまうのも手です。そしてあとでその人に知見を分けてもらうとよいでしょう。
