...
==== 「定義の曖昧さ」の解決
  ...
  最小見積もりと最大見積もりを定義したことにより、定義の曖昧さは完全に無くなります。そのため、集めた見積もりの精度が上がりますし、数値から進捗に対する危機感が正確にわかります。

==== 「パーキンソンの法則」の解決

  見積もりの精度がタスク毎に表現されるため、バッファは作業時間ではなくちゃんとバッファとして使用されるようになります。
  そのため、タスクを抱え込むことなく、さっさと次のタスクを始める喜びを感じます。

==== 「学生症候群」の解決

  最小見積もりを達成しようと努力するため、タスクの開始直後から全力で作業できます。
  そのため、作業の最初に無意味なバッファ消費が起こりづらくなり、見積もりどおりにタスクが完了する可能性が向上します。
