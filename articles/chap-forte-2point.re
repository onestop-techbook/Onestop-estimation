...
ここで重要なのは@<b>{ふりかえりによる改善の対象となりやすい}ということです。1点見積もりで見積もりより実績が少なくなった場合は、誰かが見積もりより小さいことは問題だといわなければ改善の対象になりにくいです。しかし、2点見積もりでは最小と最大とふたつの定義があることによって、実績が最小と最大のどの位置なのかを考えやすくなります。そのため、強く意識しなくてもふりかえりがしやすくなります。

 * 見積もり精度を上げやすい

前述のふりかえりの話にも関連していますが、ふりかえり結果から見積もり精度を上げやすいのも特徴のひとつです。1点見積もりでは実績が見積もりを上回ったか、下回ったかのどちらかしかありません。2点見積もりでは最小以下、最小と最大の間、最大の大きく三つに分かれます。また最小と最大の間でも、最小寄りなのか最大寄りなのかによっても次の行動を変えられます。これだけ評価軸を増やせるのはふたつの見積もりを用いる利点となっています。

たとえば1点見積もりでは実績が見積もりを超過した場合、対応はまちまちとなります。「まぁ見積もりだからねー仕方ない」と言って特に何も対応しないケースもあるでしょうし、「じゃあ次回から少し見積もりを増やそうか」みたいな表面的な対応にしかならないケースがあります。

しかし、2点見積もりでは見積もりの定義が明確です。最大見積もりの定義は「そのタスクが確実に完了できる工数」なので、確実に完了できる工数を超過していることになります。そのため、事前に検討できていない項目があったのではないか、見積もり内容に問題があったのではないか、タスク消化中に非常に大きな問題が発生したのではないか、など単に不確実な見積もりを超過した以上に考えやすいでしょう。


 * コミュニケーションが楽

 2点見積もりでは、見積もりした数値に関するコミュニケーションが楽ということがあります。これは出てくる数値の定義がはっきりしているからです。1点見積もりではその数値の定義があいまいであるため、ギリギリの見積もりなのか、マージンを含んだ見積もりなのかがわかりません。そのため、毎回定義を確認する必要があります。特にふりかえる際のコミュニケーションが楽になります。普段、見積もりをしたときにその見積もりがどういう定義の見積もりなのかはよく覚えていないことが多いです。個々の見積もりひとつひとつに対して、マージンが多めだったかどうかとか、ギリギリの見積もりだったかなどは覚えて入られません。特に自分の見積もりならまだしも、他の人も含めてその定義を確認して管理していくのは非常に骨が折れます。

 その点、2点見積もりであれば最初から定義が決まっているので、過去のことを思い出す必要はありません。決められた定義のまま扱えば大丈夫です。チーム内や組織内でコミュニケーションを取るときも認識の違いが起こることはありません。勘違いや前提の違いで手戻りが発生しにくいのはよいポイントです。見積もり自体が不確実なものなのに、それを運用する中に不確実性が非常に大変です。少しでも不確実性が減らせるとよりよい見積もりができます。
...
ただし、単純にチームに2点見積もりを伝えようとするとうまくいかないことがあります。単に2点で見積もりの内容だけ伝えると、いつもの見積もりにマージンを足しているだけと受け取られてしまい、代わり映えがしないものに見えてしまいます。そのため、2点見積もりをチーム内に伝える時は方法や定義よりも今現在のチームに対してどういったメリットがあるかを伝えた方がよいです。もちろん、まずは自分で試してみて実感してみるのが大事なのは言うまでもありません。

=== モチベーションの持続
見積もりを正確に行い続けることはできません。どんなに経験を積んでもズレる時はズレます。特に完璧主義の人（またはその傾向がある人）は、外れることがあると分かっていても気にしてしまいストレスを感じるものです。特に1点見積もりは1点しかないので、まずピッタリと一致することはありません。多少ズレてしまった見積もりをほぼピッタリだったと自分を慰めた経験がある方もいるでしょう。そうしてズレることに慣れていくと、見積もりをする意義が見出せなくなっていきます。そして、自分のための見積もりというよりも、いわれたから提出するための無意味な儀式や数字遊びになっていってしまいます。

2点見積もりは最初からブレることが前提となっています。つまり最小見積もりと最大見積もりという2点になるため、その間に入ればまずは想定とおりとなります。つまり見積もりとしては高い確率で自分の想定とおりとなります。そういう意味で外れることが少ないので、見積もりに対して高いモチベーションを保つことができます。また、最小見積もりをストレッチ目標として意識することで、より正確な最小見積もりを出すモチベーションになります。すぐ到達できる目標よりもできそうでできないレベルの方がモチベーションは維持しやすいです。
...
2点見積もりでは最小工数が目標になります。最小工数は最小で終わる定義として見積もりしているため、これを達成するために努力できます。また、最小見積もりを超過してしまっても次は最大見積もりを目標に作業することができます。これにより作業中は常にポジティブな目標を持って作業することができます。1点見積もりだと見積もりを超過しないようにするための見積もりだったので、どちらかといえばネガティブな印象でした。2点見積もりではそれがポジティブな印象に変わったと感じました。

== 2点見積もりの欠点
ここまで、筆者の事例による2点見積もりの利点をお伝えしてきました。実際に2点見積もりをやってみると、多くの利点を感じることができました。

では逆に欠点についてもお伝えします。とはいっても、欠点というほどの欠点は思いつきませんでした。やってみる前は単純に見積もり作業が2倍になるかと思っていましたが、そんなことはありませんでした。1点見積もりも2点見積もりも、最初にその作業が完了するまでに必要な最小限の工数を考えます。そこからマージンや不安な部分を加味した見積もりにします。これは1点見積もりでも不完全ながら2点見積もりのようなことをやっていたということです。そのため、作業量が2倍になるということはありませんでした。最小工数を出すために細かくタスクの分割などをするようになりましたが、これはより正確な見積もりを出すために必要なので欠点とまではいえないでしょう。
...
見積もりをしていて、こんなことをいわれたことはないでしょうか?そんなときこれまでは明確な根拠もない今までの経験で乗り切ってきたことでしょう。ですが、2点見積もりとふりかえりを続けることで、こんな質問にもこう答えられるようになります。
...
見積もりに対してこれらを逐一記録していきましょう。面倒だし続けるのがかなり億劫ですが、ふりかえりによる効果を享受するには必要な作業です。次のように工夫してやっていくようにしましょう。
