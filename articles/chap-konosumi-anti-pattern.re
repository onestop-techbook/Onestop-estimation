...
私の場合、設計はほとんど、テキストや箇条書きレベルです。体裁を整えたり、見栄えをキレイにといったことを考え始めると、設計はとても時間がかかります。
...
最大工数を考えるということは「このタスクにはこんなリスクがある」を考えることに繋がります。実際、タスク毎の工数超過は、考慮漏れや懸念点の発生によって起こることがほとんどです(あと突然の仕様変更)。
 ...
 * プロジェクトをリードする技術
 * @<href>{https://kakakakakku.hatenablog.com/entry/2018/04/23/223304}
 ...
 * @<href>{https://www.amazon.co.jp/dp/B0148E90R2/}
