...
発注者として、見積もり依頼を行う場合の基本的な流れについて述べる。小規模であるとはいっても必要な事項はプロジェクトの規模によらないし、むしろ基本的な内容を自分で処理する必要があるからテーマとしては良いだろう。

== 準備するもの

=== 見積もり仕様書
以下の項目について記載した、見積もり仕様書をつくる。定型フォーマットを作っておくと良い。
...
　材質：SUS　304
　加工精度：一般公差による。
　・加工精度：長さ寸法に対する許容差（JISB0405-1991）による。
　・加工精度：一般公差による。
　・加工精度：xxの精度は、50mm±0.001mm以内、それ以外は一般公差とする。

　6.　見積もり範囲
　納品物に含まれるもの、含まれないものを明記する。
　納品物、支給部材、見積もり範囲外、貸与品等について整理して記載する。　
　それに基づいて納品され、検収条件にも関わるので注意が必要である。
特殊な素材、あるいは手持ち部材に追加工を依頼する場合など、支給品を記載する。
貸与品についえてゃ、製作者の方で所有しないものが製作の前提となる場合などに記載する。高価・特殊な測定器、環境構築・機材が必要な場合などを貸与する場合に記載する。無償有償を明記する。
...
PPT等で作る場合、フリーフォーマットで良いが、適宜図表等を利用して、打ち合わせをスムーズにできるとよい。
...
例：100kHzでサンプリングしたいが、ハードウエアの制約で10kHzでしかできない（ためハード選定からやり直す）といった致命的な手戻りをなくすことができる。
例：機械加工での製作物では、ポンチ絵をつける。CADでの清書までは求めないが、図あると、文字での説明とは比べ物にならないほど意思伝達がスムーズになる。必要な寸法や加工精度、加工内容について記載する。
...
== 発注
見積もり書をもらい、発注する。会社であれば、発注自体は契約担当者がいるはずなので、そこに任せることになるだろう。進捗を適宜確認し、疑問点があれば回答する。
...
== 注意事項
発注者はおカネを払う側などで、一般に発注者のほうが力が上の場合が多い。だから、お願いも聞いてもらいやすいし、よしなにやってといった（限度はあるが）無茶を聞いてもらえる場合も多いだろう。さらに、大きめの企業から（相対的に）小さい企業、あるいはフリーランスに発注するなどのように、会社・立場からの力の差があることも多い。

だからといって、無理難題を無理に飲ませる、といったことは当然やってはならない。法律的にも、下請法などで厳しく規制されているし、相手あっての仕事でもある。一回は飲んでもらえたとしても、次お断りされる、といった悲しいことになる。とはいえ、受容限界を超えるとそうなるのは当然であろう。
