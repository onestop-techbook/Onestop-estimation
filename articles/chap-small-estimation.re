...
支給部材および貸与品については、必要に応じて記載する。製作・調達にあたって特殊な素材や機材が必要な場合、あるいは手持ち部材に追加工を依頼する場合など、支給品・貸与品がある場合に記載する。

貸与品については、製作者の方で所有していない・準備が困難なものが製作の前提となる場合などに記載します。高価・特殊な測定器、環境構築・機材が必要な場合などであり、貸与する場合に記載します。また、貸与が無償なのか有償なのかを明記します。

製作などにあたってメーカーの方で必要な機材がある場合、ぜひ貸与することを考えてください。貸与することで、メーカーで購入、借用する必要がなくなりますので、トータルでの出費を下げることができます。もちろん発注者側に手持ちがない場合などは仕方ありませんが、メーカーに貸し出すことでその機材の入手を考える必要がなくなり、納期も短くなりますし、費用も下がります。
...
　　Arduinoボード
　貸与品
　　Arduinon 1個。　Arduinoに接続する温度センサ　1式。無償貸与とする。
//}

このように記載することで、メーカーは、Arduinoの調達を行う必要がなくなり、ソフト開発に専念することができます。Arduinoおよびセンサの調達にかかわる部分のメーカーの工数分安価・短納期にすることができるでしょう。
