...
== 発注
見積もり書をもらい、発注する。会社であれば、発注自体は契約担当者がいるはずなので、そこに任せることになるだろう。進捗を適宜確認し、疑問点があれば回答する。発注側として、進捗をチェックするとともに、途中で必要に応じて実装の中身が正しいか（意図した通りか）を確認する必要がある。
...
また、金額も、10万円以下は経費、10万～20万は少額固定資産、20万以上は設備といった税務上の制約、あるいは稟議・決裁のレベルなどの制約もあるかもしれない。これらについても、参考情報として共有しておけると、発注者側ネックでの遅れが生じづらくなるなどの理由でスムーズに進む可能性がある
