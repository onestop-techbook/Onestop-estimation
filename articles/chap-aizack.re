...
SIerである今の会社に入社してしばらくは、上司（またはPM、PL）に「その作業、いつ終わる？」と聞かれるのが怖くて仕方ありませんでした。当時は、自分の作業がいつ終わるのか見積もることができなかったためです。  
そんな私でも、2年程SEとして経験を積むことで作業見積もりに関する自分なりのTIPSのようなものを獲得し、今ではだんだんと見積もりができるようになってきました。
