...
しかし1回説明では成果物が想像できない、または理解したつもりで検討違いの成果物を作成してしまうということがあります。

上記のような問題を回避するためのフレームワークとして、利用をオススメするのが「5W1H」です。
やり方としては、依頼の説明で受けた内容を下記表1.1のように各項目に振り分けるだけです。
...
上記のように依頼内容を項目毎に振り分けることができれば、その作業内容とその背景を整理することができます。
また、整理を行うことで作業の方針や手順まで具体的にイメージしやすくなるため、

=== 2. 作業内容の確認と方針の合意
==== 上司へ質問・確認すべき事項
「5W1H」に振り分けした際に埋めることができない、うまくまとめられない項目がある場合は、@<b>{説明の際に必要な情報が抜けていたか、内容を理解できていない部分がある}ということになります。
そういったものがある場合は、振り分けることができ自身が理解している項目を伝えた上で、わからないことを聞くとよいでしょう。
また、項目を埋めてみて作業工程や手順をイメージした際に知っておきたいと感じたことがあれば、同時に聞いてみてください。         
ちなみに、私は口頭での説明が苦手であるため事前にメモを準備して話に望みます。
メモを相手にみせながら説明するとより相手に多くの情報が伝わるため、互いに勘違いが起きにくくなります。

==== 作業方針の確認と合意
5W1Hを書き起こしと質問確認が完了し作業の方針が決まったら、上司に作業方針の確認を行いってその合意を取ることをオススメします。
...
=== 3. 1章まとめ
この章では、依頼内容を正しく把握するためにその成果物や背景を定義するための考え方を述べてきました。
また、その際不明だった点の確認と作業方針を決定した後に上司との間で合意を得ることもお伝えしました。
上記で述べた考え方を利用すれば、開始時点から目的を逸れ、大きな手戻りが発生するリスクを軽減することができます。
...
このときの経験から「エイヤ！」で見積もりをしないための方法を私は編み出しました。
...
//image[estimation_of_time_table][作業時間把握テーブル作成例]{ 
//}
      * 上記Excelを利用した作業時間見積もり
            

      
      * メリット
            上記の作業時間管理を行うと次のような報告を行う際に、一々自身の稼働時間や作業内容をメール等からサルベージする必要がなくなり非常に便利です。
            もし、これらの記入に毎月/毎週困っているかたがいらっしゃた場合、上記の方法は有効ですよ。
            * 日報/週報の記入
            * 客先用作業報告書の記入
            * 勤怠システムの入力 
...
=== 1. 作業状況の細かい報告         
      * 報告はなるべく短いスパンで、かつ具体的に行う
            ...
            もし上記が難しいのであれば、あらかじめ上司から与えられた期間の半分が経過した時点で報告を行うことが良いでしょう。
...
==== 報告のメリット
      * 作業範囲のズレを抑えることができる
            ...
            そのような指摘を通じて、作業を本来の目的に沿った状態へ修正することができます。
            上記のようなフィードバック→修正という流れを繰り返すことで、勘違いによる完成直前での作業やり直しなど致命的な問題を回避することに繋がります。
      ...
      * 上司の信用を獲得しやすくなる
            ...
            この経験から、報告1つあるだけで管理する側を安心させることできます。
            上記のように安心の積み重ねが信用につながってくるはずです。
            私自身、作業報告を細かく行うようになってから「その作業、いつ終わる？」という恐怖の質問が飛んでこなくなりました。
            上司が私の作業状況が把握しているためわざわざ聞く必要がないと思ってくださったのだと思います。
...
==== 報告することの思わぬ効果
      * 頭の中が整理される            
            ...
            私の場合は、普段報告する際には-1の作業報告のポイントにしたがって説明用のメモを作成することで頭の整理を行っています。
            それを通して、作業における課題として上げているものがの原因はなんなのかやその課題を解決するためのヒントが見えてくることがあります。
      ...
      * 上司からのフィードバックを得やすくなる
            ...
            このようなフィードバックは中々自身では認識できていないため、いわれてはじめて気がつくことが多く、自分自身を客観的に見るチャンスでもあります。
            自身を客観的に見ることで自身の強み、弱みを知り今後のお仕事や私生活において注力すべき点が見えてきます。
            これらは成長するきっかけとなるため、フィードバックを得られるようにコミュニケーションとして報告を活用することをオススメします。

=== 3.3章まとめ
この章では、なるべく頻繁に作業報告を行うことを通じて作業者が受ける恩恵について述べてきました。
