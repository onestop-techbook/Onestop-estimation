...
SIerである今の会社に入社してしばらくは、上司（またはPM、PL）に「その作業、いつ終わる？」と聞かれるのが怖くて仕方ありませんでした。当時は、自分の作業がいつ終わるのかを見積もることができなかったためです。  
そんな私でも、2年ほどSEとして経験を積むことで作業見積もりに関する自分なりのTIPSのようなものを獲得し、今ではだんだんと見積もりができるようになってきました。
...
この記事を通じて、読者のみなさんが、誰も教えてくれない見積もりの技術を考え、向上させていくきっかけになれば幸いです。
...
本稿の対象は次のようなエンジニアです。
      ...
      * 上司からあらかじめ作業内容と期間が決められたものを依頼される
      * 上記の状況を改善したいという思いがある
...
ここからは、上記のポイントを踏まえて作業を取り組むための工夫を紹介していきます。

【確認の目的】    

      1. 依頼者から説明を受けた内容や作業開始に必要な情報のヌケモレの有無を把握するため  
      2. 依頼者と作業者の依頼内容の成果物に対する認識を合わせるため  
      3. 上記を通じて、作業全体の手戻りをへらすため  

=== 5W1Hの明確化

1回の説明だけで依頼内容を把握し、依頼主の求めた成果物を渡すことができればそれに越したことはありません。
実際には、それだけでは成果物が想像できませんし、理解したつもりで見当違いの成果物を作成してしまうということもあります。

上記のような問題を回避するためのフレームワークとして、オススメするのが「5W1H」の考え方です。
...
このように、依頼内容を項目毎に振り分けることができれば、その作業内容とその背景を整理することができます。
また、整理を行うことで作業の方針や手順までを具体的にイメージしやすくなります。

=== 作業内容の確認と方針の合意

「5W1H」に振り分けした際に埋めることができない、もしくはうまくまとめられない項目がある場合は、@<b>{説明の際に必要な情報が抜けていたか、内容を理解できていない部分がある}ということになります。
そういった項目がある場合は、振り分けができて自身が理解している項目を伝えた上で、依頼者にわからないことを聞くとよいでしょう。
また、項目を埋めて作業工程や手順をイメージした際に知っておきたいと感じたことがあれば、同時に聞いてみてください。

ちなみに、私は口頭での説明が苦手なので、事前にメモを準備してから打ち合わせにのぞみます。
メモを相手に見せながら説明するとより相手に多くの情報が伝わるため、互いに勘違いが起きにくくなります。

5W1Hの書き起こしと質問確認が完了し作業の方針が決まったら、上司に作業方針を確認して合意を取ることをオススメします。
なぜなら、依頼者によって作業の際「気にしてほしい点」がまったく異なるからです。

方針の確認・合意をせず、上司の「気にしてほしい点」から外れた成果物を提出してしまった場合、修正指示を受けて作業のやり直しが発生する可能性があります。
そのため、上記のようなリスクを回避するためにも、作業開始前に方針を話し合って合意を得ておくことをオススメします。
場合によってはその話し合いの中で、作業時に気をつけてほしい点などの具体的な指示や説明を受けることができるかもしれません。

==={a} まとめ

作業前に依頼内容を正しく把握するための方法として、次のようなものを紹介してきました。
...
この章では、上司と相談の上で合意した作業方針を基に、実際の作業時間を見積もっていくための工夫を述べていきます。
ここでのポイントは、@<b>{自分がどの作業にどれだけの時間を掛けているかを正確に把握すること}です。
ここでは、上記のポイントを踏まえて、作業時間の見積もりを行う工夫とそのメリットを紹介していきます。

 【作業時間を把握する目的】  

 1. 依頼内容のうち、「どの作業に、どれだけの時間を掛けているか」を客観的に把握し、正確な作業時間見積もりを行うため  
 2. 作業時間の把握を通じて、自身の現在の実力を客観的に把握するため  
 3. 依頼内容に関する上司への相談や報告を正確に行うため  
 
=== 作業時間見積もりの失敗談

皆さんは自分の作業時間を見積もるようにいわれた際、適当に「エイヤ！」と見積もってしまった経験はありませんか？

私は見積もりの方法を知らなかった1年目にそれをやってしまいました。自分の実力よりも期限を短く設定してしまい、間に合わせるためしばらく残業を行うはめになったことがあります。
...
//}
            ...
            これを上記の手順で作業見積もりを行ってみたのが次の図3.2です。  

//image[additional/task_calc_estimation_of_time][作業見積もり計算例]{
//}
            第一に作業のグループ分けとして、この例ではタスクAとタスクBグループとしてわけ背景色を変更しました（１）。
            次に、それぞれのタスクの実施時間計測を（２）で行い、タスクAは1回につき20分、タスクBは60分かかることが判明しました。

            その結果を基に（３）タスクA配下全体の実施時間とタスクB配下全体の実施時間を計算を行います。
            最後に、（３）で求めた最短の作業見積もりにマージン分の1.5を掛け、（４）の「12.45H」作業に必要だと見積もることができました。
			
		このように最短とマージン込の必要作業時間を見積もることで、「エイヤ！」と見積もるより現実的で説明可能な数字をもとめることができます。 

            上記の作業時間管理を行うと次のような報告を行う際に、いちいち自身の稼働時間や作業内容をメール等からサルベージする必要がなくなり非常に便利です。
...
これらを通して、正確に作業時間を見積もるための工夫とそのメリットは伝えることができたと思います。
ヤマ勘で「エイヤ！」とやるよりもよっぽど客観的な計算ができるので、今後見積もりを行う際にはこのメソッドを利用してみてください。

== 作業中から作業完了時~依頼作業状況の報告~

この章では、作業中から作業完了後までの間で行う「作業報告」に関する工夫を述べます。
ここでのポイントは@<b>{なるべく頻繁に作業報告を行い、その恩恵を得ること}です。
このポイントを押さえて、上司への作業報告を行うための工夫を紹介していきます。
...
=== 細かい報告を行うメリット
 ...
 : 作業の期間や内容を調整できる  
            ...
            作業中にその前提が覆ったり、優先度の高いタスクを割り込みで頼まれたりすることがあります。
 ...
 : 上司の信用を獲得しやすくなる  
            ...
            仕事を任せて時間が経つのに、何も報告がないと任せた側は不安になります。
            
            以前オフショア開発先と日本側の調整役をしていた時、オフショア先からの進捗報告が滞っており、予定どおり作業が進んでいるのか把握できずに困ったことがありました。
            結局は日本側から進捗確認を行い、問題はないことが確認されましたが、作業状況がわからないだけで管理側がいかに不安になるのかを実感した出来事でした。
