...
そして、アジャイルにおなじみのイテレーションの中で**チームとして**どれくらいのポイントをこなすことができるかを測るのです。
...
ストーリというとユーザーが何々をできるようになるのような形で表わされるわけですが、我々開発者が行なう作業としてはもうすこし細分化されたタスクとして分解されます。ですので実際にはタスクのポイントとして見積りが行なわれていました。
...
スクラムが単に経験的に良い手法であるということではないということが伝えられれば本稿の目的が逹っせられたのではないかと思います。
