...
それはもう実装段階に入ってしまえばよいのであり、そもそも技術調査というものの必要性が問われます。

技術調査というのは、技術的に高度な内容を頼むわけですから、比較的案件が高い、高いスキルなエンジニアを
アサインすることになります。そのような単価が高いエンジニアを、直接のユーザー向けの機能開発に関わらない
内容にフルアサインするだけの予算が出せる顧客がいるかといえばいるかもしれないし、いないかもしれないです。

顧客側の都合はともかくとして、現状そのような、案件の立ち上げ時等の技術検証の案件は、需要に対して
技術者側の供給が追いついてないです。そのような高いスキルのエンジニアというのは半年とか一年で
育成できるわけでないので、大体一人のエンジニアが複数案件を担当することなります。

基本的にコンサルティングは、プリンシパルな高単価のコンサルタントの下にジュニアクラスの比較的低単価な
コンサルタントがぶらさがってチームを形成するのですが、技術調査、特に筆者の主とする自動化や継続的デリバリーなどの領域は、
細かい部分まで高スキルのエンジニアが実装を担当しなければ成果物の完成には至らないので(ソフトウェアエンジニアのみなさんならわかりますよね？)、メインで担当する案件が最後まで面倒をみることになります。
...
そのような、検証済みの手持ちの札をどれだけ増えせていけるか、というのが、技術コンサルタントとしてやっていく上での生命線になります。
